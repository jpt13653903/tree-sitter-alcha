...
static void register_keywords(TokenTree* token_tree)
{
    ...
    token_tree_insert(token_tree, "coverbins",  KEYWORD);
    token_tree_insert(token_tree, "covergroup", KEYWORD);
}
//------------------------------------------------------------------------------
...
{
    token_tree_insert(token_tree, "sin",        BUILTIN_FUNC);
    token_tree_insert(token_tree, "cos",        BUILTIN_FUNC);
    token_tree_insert(token_tree, "tan",        BUILTIN_FUNC);
    token_tree_insert(token_tree, "asin",       BUILTIN_FUNC);
    token_tree_insert(token_tree, "acos",       BUILTIN_FUNC);
    token_tree_insert(token_tree, "atan",       BUILTIN_FUNC);
    token_tree_insert(token_tree, "sinh",       BUILTIN_FUNC);
    token_tree_insert(token_tree, "cosh",       BUILTIN_FUNC);
    token_tree_insert(token_tree, "tanh",       BUILTIN_FUNC);
    token_tree_insert(token_tree, "asinh",      BUILTIN_FUNC);
    token_tree_insert(token_tree, "acosh",      BUILTIN_FUNC);
    token_tree_insert(token_tree, "atanh",      BUILTIN_FUNC);
    token_tree_insert(token_tree, "log",        BUILTIN_FUNC);
    token_tree_insert(token_tree, "log2",       BUILTIN_FUNC);
    token_tree_insert(token_tree, "log10",      BUILTIN_FUNC);
    token_tree_insert(token_tree, "exp",        BUILTIN_FUNC);
    token_tree_insert(token_tree, "pow",        BUILTIN_FUNC);
    token_tree_insert(token_tree, "round",      BUILTIN_FUNC);
    token_tree_insert(token_tree, "fix",        BUILTIN_FUNC);
    token_tree_insert(token_tree, "floor",      BUILTIN_FUNC);
    token_tree_insert(token_tree, "ceil",       BUILTIN_FUNC);
    token_tree_insert(token_tree, "rand",       BUILTIN_FUNC);
    token_tree_insert(token_tree, "real",       BUILTIN_FUNC);
    token_tree_insert(token_tree, "imag",       BUILTIN_FUNC);
    token_tree_insert(token_tree, "abs",        BUILTIN_FUNC);
    token_tree_insert(token_tree, "angle",      BUILTIN_FUNC);
    token_tree_insert(token_tree, "fft",        BUILTIN_FUNC);

    token_tree_insert(token_tree, "read",       BUILTIN_FUNC);
    token_tree_insert(token_tree, "write",      BUILTIN_FUNC);
    token_tree_insert(token_tree, "append",     BUILTIN_FUNC);
    token_tree_insert(token_tree, "textread",   BUILTIN_FUNC);
    token_tree_insert(token_tree, "textwrite",  BUILTIN_FUNC);
